...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.chat.createChatParticipant('vscode-commander', createChatParticipant(updatedSettings, ranCommands, chatContext, configurations, logger)));
